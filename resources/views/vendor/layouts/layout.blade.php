...
<body>
	<div class="wrapper">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item {{request()->routeIs('vendorDashboard')?'active':''}}">
				<a class="sidebar-link" href="/vendor/dashboard">
	  <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
	</a>
			</li>

			<li class="sidebar-item {{request()->routeIs('vendor.order.history')?'active':''}}">
				<a class="sidebar-link" href="/vendor/order/history">
	  <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Order History</span>
			...
			<li class="sidebar-item {{request()->routeIs('vendor.product.create')?'active':''}}">
				<a class="sidebar-link" href="/vendor/product/create">
	  <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create Product</span>
			...
			<li class="sidebar-item {{request()->routeIs('vendor.product.manage')?'active':''}}">
				<a class="sidebar-link" href="/vendor/product/manage">
	  <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage Product</span>
			...
			<li class="sidebar-item {{request()->routeIs('vendor.store.create')?'active':''}}">
				<a class="sidebar-link" href="/vendor/store/create">
	  <i class="align-middle" data-feather="shopping-cart"></i> <span class="align-middle">Create Store</span>
	</a>
			</li>
